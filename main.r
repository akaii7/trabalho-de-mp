...
print("--------------------")
print("Plot:")
ozone_plot <- plot(airquality$Ozone,type="l",main="Ozônio")
solar_plot <- plot(airquality$Solar.R,type="l",main="Radiação Solar")
wind_plot <- plot(airquality$Wind,type="l",main="Velocidade do Vento")
temp_plot <- plot(airquality$Temp,type="l",main="Temperatura")
print("Vá para Rplots.pdf")